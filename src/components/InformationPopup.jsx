    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white rounded-lg p-8 shadow-lg w-full max-w-3xl mx-4 relative overflow-auto max-h-full">
        ...
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-[#FF5C00] mb-4">Features:</h2>
          <ul className="list-disc list-inside mb-6 text-left text-gray-700 mx-auto max-w-lg">
          ...
          <h2 className="text-2xl font-bold text-[#FF5C00] mb-4">Community Guidelines:</h2>
          <p className="text-lg text-gray-700 mb-6">
