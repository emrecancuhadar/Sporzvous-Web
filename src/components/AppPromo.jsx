        ...
        <section id="download" className="py-20">
            <div className="relative flex flex-col-reverse items-center  md:flex-row">
                ...
                <div className="flex flex-col items-center justify-between space-y-6 md:items-start">
                    ...
                    <p className="mt-4 text-gray-600">Join the community and find games</p>
                    <p className="mt-4 text-gray-600">join the event with a few taps, and be a part of the amateur sports revolution!</p>
